...
Slug: cross
sortorder: 50
Summary: Changelog and release management tools for cross.

## Reviewed (11)
- **[changelog-from-release](/reviews/changelog-from-release/)** — Small CLI that backfills/generates a Markdown changelog from existing GitHub Releases.
- **[Create release notes from changelog](/reviews/create-release-notes-from-changelog/)** — GitHub Action that extracts release notes from CHANGELOG.md, optionally combines a static header, and writes RELEASE.md.
- **[GitHub Automatically Generated Release Notes](/reviews/github-automatically-generated-release-notes/)** — Built-in GitHub release-note generator based on merged pull requests, contributors, and changelog comparison links.
- **[GitLab Changelogs](/reviews/gitlab-changelogs/)** — GitLab built-in changelog generation based on commit titles and Git trailers such as Changelog: added/fixed/changed.
