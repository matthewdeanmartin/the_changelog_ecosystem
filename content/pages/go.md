...
Slug: go
sortorder: 12
Summary: Changelog and release management tools for Go.

## Reviewed (4)
- **[changelog-generator](/reviews/changelog-generator/)** — Configurable commit-based changelog generator that groups commits since the previous release.
