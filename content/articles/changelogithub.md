...
`changelogithub` is a npm cli tool for managing changelogs and releases.

CLI for generating GitHub release changelogs from Conventional Commits, powered by changelogen.
