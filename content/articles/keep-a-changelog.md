...
`Keep a Changelog` is a standard tool for managing changelogs and releases.

Human-centered changelog format and vocabulary that many tools target or partially implement.
