...
`git-chglog` is a go cli tool for managing changelogs and releases.

Go-based changelog generator that uses git tags and commits with configurable templates.
