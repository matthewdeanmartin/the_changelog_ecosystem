...
`cargo-release` is a cargo subcommand tool for managing changelogs and releases.

Cargo subcommand for crate release automation; commonly combined with git-cliff or cargo-dist for changelog/release pipe
...
- Repository: [https://github.com/crate-ci/cargo-release](https://github.com/crate-ci/cargo-release)
