...
Drop-in replacement for tipcalc/__init__.py at life-cycle stage 4 (second loop).
The output shape changes (one line per diner), making this a good 'breaking-ish'
feature for changelog tools that distinguish feat vs feat!.
"""
